...
router.post('/', async (req, res) => {
  ...
  const { rows } = await pool.query('INSERT INTO transactions (user_id,title,amount,category,type,date) VALUES ($1,$2,$3,$4,$5,$6) RETURNING *', [req.user.id, title, amount, category, type, date]);
